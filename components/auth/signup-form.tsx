...
export function SignUpForm({
  ...
  const handleSignUp = (e: React.FormEvent) => {
    ...
    startTransition(async () => {
      const fields = signUpSchema.safeParse({ email, password, confPassword });
      
      console.log(fields.data)
      console.log("fields before success : ", fields.error?.message)
      ...
      console.log("fields after success : ", fields)
      
      const result = await register(fields.data);
      ...
      if (!loginResult?.error) {
        ...
        setErrors({ password: "Login failed after registration" });
      }
    });
  };
